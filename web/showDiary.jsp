...
<html>
    ...
    <center>
        <a href="writeDiary"><button  id="writeDiary" type="submit">
                <h2>Write diary</h2>
            </button></a>
    </center>
    <div class="content">
        <ul>
            <c:forEach var="diary" items="${requestScope.dataDiary}">
                <a href="modifyDiary?id=${diary.getId()}" class="diary-link"><div class="listDiary">
