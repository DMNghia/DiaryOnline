...
<html>
    ...
    <body>
        ...
        <div class="book">
            <form action="diaryPostShared" method="GET">
                <div class="cover">
                    <h1>Your Diary</h1>
                    <input id="title" type="text" name="title" value="${diary.getTitle()}" readonly="" placeholder="Write title here">
                </div>
                <div class="page">
                    <textarea placeholder="Write your diary here" readonly="" name="content">${diary.getContent()}</textarea>
                </div>
